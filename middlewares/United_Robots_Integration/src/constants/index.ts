/**
 * This constant defines the current version of the ANS schema to be used
 */
export const ANS_SCHEMA_VERSION = '0.10.7';
...
/**
 * Integration name in base64
 */
export const INTEGRATION_NAME = 'VW5pdGVkIFJvYm90cwo=';
